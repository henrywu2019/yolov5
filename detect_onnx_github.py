...
def detect_onnx(official=True, image_path=None):
    ...
    session = onnxruntime.InferenceSession('./models/yolov5s_img-640-640_batch-1_device-cpu_dynamic-False_grid-False.onnx')
    print("The model expects input shape: ", session.get_inputs()[0].shape)
    batch_size, channel, img_size_h, img_size_w = session.get_inputs()[0].shape
